...
from components.pmr_component import PMRComponent
...
class GithubProfilesAutomatorCharm(ops.CharmBase):
    ...
    def __init__(self, framework: ops.Framework):
        ...
        self.pmr_component = self.charm_reconciler.add(
            component=PMRComponent(
                charm=self,
                name="PMR component",
            ),
            depends_on=[self.leadership_gate, self.pebble_service_container],
        )
