...
Contributors in an agnostic way. Specifically it is a custom data structure
consisting of a mapping of Profile objects.


With this representation it's then possible to write functions that manipulate
a Kubeflow cluster based on a PMR.
