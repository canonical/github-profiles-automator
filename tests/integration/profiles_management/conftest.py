...
def lightkube_client():
    ...
    log.info("Initializingn lightkube client")
    return lightkube.Client(field_manager="profile-automator-tests")


@pytest.fixture(scope="module")
async def deploy_profiles_controller(ops_test: OpsTest):
    """All tests will need to manipulate Profiles in some way.

    For this we'll need to have the Profiles Controller deployed, to ensure
    the underlying namespacecs and resources will be created.
    """
