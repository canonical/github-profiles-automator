...
from profiles_management.helpers.kfam import (
    ...
    rolebinding_matches_profile_contributor,
)
...
def test_rolebinding_not_matching_empty_profile_contributors():
    ...
    assert not rolebinding_matches_profile_contributor(rb, profile)
...
def test_rolebinding_matching_profile_contributors():
    ...
    assert rolebinding_matches_profile_contributor(rb, profile)
